...
public class MemberManagementDemo {
	...
	public void run(String inputDate) {
	...
	//5. print() 메서드를 호출하여 번호를 선택할 수 있다.
	...
	// 만약, 수정할 아이디가 없다면, '수정할 아이디가 없습니다.' 메시지 출력.
	...
	//1. 삭제할 아이디를 입력받는다.
	//2. ArrayList의 Member 객체 중에서 삭제할 아이디를 찾아 있
	public void delete() {
